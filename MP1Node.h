...
private:
	...
	// Helper functions
	bool selfIsPartOfMemberList();
	void addrToIDPort(char *addr, int *id, short *port);
...
public:
	...
	// recvCallBack handlers
	void handleJOINREQ(Member *node, MessageHdr *msg);
	void handleJOINREP(Member *node, MessageHdr *msg, int size);
};
